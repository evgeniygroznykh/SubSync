...
def get_subtitle_filename_from_clip(clip, language):
    return f"{clip.clip_name.split('.')[0]}_{language}.stl"
...
def get_base_name_list(file_list):
    return [f_name.split('.')[0] for f_name in file_list]
