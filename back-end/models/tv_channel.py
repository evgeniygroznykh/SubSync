...
class TVChannel:
    def __init__(self, channel_name, channel_clip_dir, channel_sub_dir, channel_sub_src_dir, subtitle_languages):
    ...
    def get_tv_channels(config):
        ...
        for node in channel_nodes:
            ...
            cur_tv_channel = TVChannel(cur_channel_name, cur_channel_clip_dir,
                                       cur_channel_sub_dir, cur_channel_sub_src_dir, cur_channel_subtitle_languages)
